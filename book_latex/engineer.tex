...
\begin{document}
  ...
  %  \input{chapters/chapter_4/main} TRESC PRZENIESIONA DO ROZDZIALU 3
    ...
    \input{chapters/chapter_8/main}

    \input{chapters/chapter_9/main}

    \input{chapters/chapter_10/main}

    \input{chapters/chapter_11/main}

    \input{chapters/chapter_12/main}

    \printbibliography[title={Bibliografia}]
%    \printbibliography[title={Bibliografia}, heading=bibintoc]

    \input{chapters/chapter_13/main}
\end{document}
