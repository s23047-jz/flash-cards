...
Weryfikacja konta użytkownika poprzez e-mail  (WF14)
}
...
\begin{requirementstab}[label={tab:requirements:e-mail_verification},caption={Wymagania na interfejs z otoczeniem dla weryfikacji konta użytkownika poprzez e-mail}]
    \id{WF14}
    \priority{C – could}
