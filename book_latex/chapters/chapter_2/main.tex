...
\begin{enumerate}
    ...
    \item Gamifikacja - wykorzystanie elementów gier w niezwiązanym z grami kontekście\footcite[tutaj tekst?]{gamificationWiki}.
    \end{enumerate}
