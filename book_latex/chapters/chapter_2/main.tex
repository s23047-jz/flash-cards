...
\begin{enumerate}
    ...
    \item Model nlp - zastosowany w projekcie model rozpoznawania i analizy instrukcji głosowych.
    \item Podobieństwo kosinusowe - miara używana do określenia podobieństwa między dwoma wektorami poprzez obliczenie kąta między nimi \cite{kosinus}.
    \end{enumerate}
