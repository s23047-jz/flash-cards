...
// @ts-ignore
const PublicDecksButtonsContainer = ({onClickPrev, onClickNext, onClickRotate, onClickBackToDecks, onClickImportDecks, onClickReportDeck}) => {
    const texts = ['Prev', 'Next', 'Rotate Side', 'back to decks', 'import deck', 'report deck']
    ...
    return (
        <div className={"grid-container-public-decks-buttons"}>
            ...
            <ButtonFlashAllFlashCards onClick={onClickReportDeck} text={texts[5]} color={button_colors[5]} border={border}></ButtonFlashAllFlashCards>
        </div>
    );
};
