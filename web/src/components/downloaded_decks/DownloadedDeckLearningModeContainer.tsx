...
import ButtonsContainerLearningMode from "../learning_mode/ButtonsContainerLearningMode";
import {useNavigate} from 'react-router-dom';
import ButtonNotMemorizedFlashCards from "../not_memorized_flashcards/ButtonNotMemorizedFlashCards";


const DownloadedDeckLearningModeContainer = () => {
...
export default DownloadedDeckLearningModeContainer;