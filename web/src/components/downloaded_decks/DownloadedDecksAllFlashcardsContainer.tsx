...
import OptionsPublicDeck from "../options/OptionsPublicDeck";
import FlashCardEditPopUp from "../flash_cards/FlashCardEditPopUp";

const DownloadedDecksAllFlashcardsContainer = () => {
        ...
        <div className={"all-flashcards-container"}>
            {isLoading ? (
                ...
                <>
                    ...
                    <OptionsPublicDeck isDeckPublic={isDeckPublic} onCloseBox={handleOpenOptions}
                             isOpen={isOpenOptions} onResetDeck={handleResetDeck}
                             onDeleteDeck={handleDeleteDeck}></OptionsPublicDeck>
...
export default DownloadedDecksAllFlashcardsContainer;