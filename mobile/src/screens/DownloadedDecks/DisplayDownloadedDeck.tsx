...
const DisplayDownloadedDeck: React.FC<ScreenProps> = ({ navigation, route }) => {
  ...
  return (
    <View className="flex-1 bg-sky-500 dark:bg-blue-900 placeholder-gray-400">
      <Text className="text-white font-extrabold animate-bounce scale-150 absolute top-16 right-16">
        Downloaded Deck Preview
      </Text>
...
export default DisplayDownloadedDeck;
