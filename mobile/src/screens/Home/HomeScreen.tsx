...
const HomeScreen: React.FC<ScreenProps> = ({navigation}) => {
    ...
    return (
        <View className="flex-1 items-center justify-center bg-sky-500 dark:bg-blue-900">
            ...
            <Image className="mx-auto object-scale-down m-5 h-40 w-40" source={Logo}/>
            ...
            <TouchableOpacity
                ...
                <Image className={'absolute flex-grow h-16 -right-6'} resizeMode={"contain"} source={Plus}></Image>
            ...
            <TouchableOpacity
                ...
                <Image className={'absolute flex-grow h-16 -right-6'} resizeMode={"contain"}
                       source={GreenCards}></Image>
            ...
            <TouchableOpacity
                ...
                <Image className={'absolute flex-grow h-16 -right-6'} resizeMode={"contain"} source={BlueCards}></Image>
